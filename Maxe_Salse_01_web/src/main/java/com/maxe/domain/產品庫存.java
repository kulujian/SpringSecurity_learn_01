...
//		super();
	...
	public 產品庫存(Date 異動時間, String 貨品代號, String 倉庫, String 庫位名稱, Integer 現有存量, String 來源程式或目加總目的) {
		super();
		this.異動時間 = 異動時間;
		this.貨品代號 = 貨品代號;
		this.倉庫 = 倉庫;
	...
	public String toString() {
		return "產品庫存查詢暫存 [異動時間=" + 異動時間 + ", 貨品代號=" + 貨品代號 + ", 倉庫=" + 倉庫 + ", 庫位名稱=" + 庫位名稱 + ", 現有存量=" + 現有存量
